...
export default function About() {
  ...
  const [textRef, isTextOnScreen] = useOnScreen({ threshold: 0.2 });
  ...
  return (
    ...
    >
      <div 
        className={`absolute inset-0 bg-cover bg-center transition-transform duration-1000 ease-out ${isOnScreen ? 'scale-100' : 'scale-110'}`}
      ...
      >
        <div className={`max-w-2xl text-left`}>
           <div className={`scroll-animate ${isTextOnScreen ? 'scroll-animate-in' : ''}`}>
          ...
          <div className="space-y-4 text-base leading-relaxed md:text-lg">
            <p className={`scroll-animate ${isTextOnScreen ? 'scroll-animate-in' : ''}`} style={{ transitionDelay: '100ms' }}>
            ...
            <ul className={`list-disc list-inside space-y-1 text-left text-primary scroll-animate ${isTextOnScreen ? 'scroll-animate-in' : ''}`} style={{ transitionDelay: '200ms' }}>
            ...
            <p className={`scroll-animate ${isTextOnScreen ? 'scroll-animate-in' : ''}`} style={{ transitionDelay: '300ms' }}>
